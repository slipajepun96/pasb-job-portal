                    ...
                    <tr class="bg-white border-b hover:bg-gray-50 candidate-row">
                        ...
                        <td class="px-2 py-4 text-right flex flex-row">
                            ...
                            <form action="{{route('get-apply_form_pdf')}}" method="POST">
                                ...
                                <button type="submit" class="bg-green-700 px-2 py-1 text-white rounded font-medium text-blue-600 hover:underline mt-1 mb-1 md:mr-1 flex flex-row inline-block"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
