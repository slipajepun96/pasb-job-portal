...
<section class="">
  ...
  <div class="max-w-screen-xl mx-auto justify-center w-auto">
    <div class="m-2 p-6 bg-white border border-gray-200 rounded-2xl shadow hover:shadow-lg">
      ...
      <h6 class="mb-1 text-xl font-semibold tracking-tight text-gray-900">IKLAN JAWATAN KOSONG : EKSEKUTIF OPERASI</h6>
      <p class="mb-2 font-semibold text-gray-700 ">Penempatan : Cameron Highlands</p>
      <p class="mb-2 font-semibold text-gray-700 ">Tarikh Tutup Permohonan : 13 November 2023</p>
        <a href="tel:+601126637117" class="inline-flex justify-center items-center my-1 py-2 px-3 text-base font-medium text-center text-white rounded-lg bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 ">
